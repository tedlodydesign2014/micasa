...
case 'headerline':
		$template		= 'default-1';
		$style			= 'mod-'.$style;
		$style			.= ($color) ? ' mod-headerline-'.$color : '';
		$subtitle		= 1;
	...
	case 'headerbox':
		$template		= 'default-1';
		$style			= 'mod-'.$style;
		$style			.= ($color) ? ' mod-headerbox-'.$color : ' mod-headerbox-default ';
		$subtitle		= 1;
		$title_template = '<h3 class="module-title">%s</h3>';
		break;
